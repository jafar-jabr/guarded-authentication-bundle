...
use Jafar\Bundle\GuardedAuthenticationBundle\Form\GuardedLoginFormTest;
 ...
 */
class LoginFormAuthenticatorTest extends AbstractFormLoginAuthenticator
{
    /**
    ...
    public function getCredentials(Request $request)
    {
        ...
        $form = $this->formFactory->create(GuardedLoginFormTest::class);
